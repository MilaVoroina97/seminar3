...
После представления программе, Вы также можете с помощью команды ***git config*** настроить гит под себя и сделать его интерфейс более удобным для себя. Подробнее [здесь.](https://git-scm.com/book/ru/v2/Настройка-Git-Конфигурация-Git)
