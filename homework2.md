...
С помощью подробного гайда по Git Вы также можете рассмотреть варианты детальной настройки и конфигурации программы. Гайд доступен по [ссылке.](https://git-scm.com/book/ru/v2)
